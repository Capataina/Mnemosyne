...
export function SelectedImageTimerPill({
  ...
  return (
    <div
      className="selected-image-timer-pill floating-surface absolute bottom-0 left-1/2 z-20 flex h-11 max-w-[calc(100%-24px)] -translate-x-1/2 translate-y-1/2 items-center gap-1 rounded-full border p-1 pl-2 shadow-[var(--shadow-float)]"
      role="group"
