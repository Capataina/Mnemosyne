...
- Zoom logic stays in exported pure functions (`zoomTransformAroundPoint`, `constrainZoomTransform`, `resolveWheelGesture`) so geometry is testable without mounting; keep new zoom behaviour in that layer.
