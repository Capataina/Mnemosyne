...
> **Note (2026-07-17):** this section was added at wrap-up to record a capability that landed after the last full upkeep pass; the surrounding telemetry-v2 section above was not re-audited against it. A proper `upkeep-context` pass should fold the two together.
