...
The audiences below were derived from `README.md`, the LifeOS vault notes (`Projects/Image Browser/Overview.md`, `Architecture.md`, `Decisions.md`, `Suggestions.md`, `Roadmap.md`, `Gaps.md`, `Systems/*`, `Work/Encrypted Vector Search.md`), local `docs/architecture/architecture.md` and `docs/engineering/decisions/*.md`, the recent git log (27 commits across the perf-diagnostics + multi-folder + CLIP-quality + AND/OR-tag-filter sweep), and `Profile/Professional/Interests.md` for career direction. Each cites verbatim project evidence in Layer 3.
...
> — `docs/engineering/decisions/conventions.md` lines 36-57
...
> — `docs/engineering/decisions/clip-preprocessing-decisions.md` line 24
