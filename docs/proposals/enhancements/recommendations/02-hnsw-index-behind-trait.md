...
8. Update `docs/architecture/systems/cosine-similarity.md` to document the dual-index choice + measured numbers. ~½ day.

Required reading before starting: `docs/engineering/decisions/random-shuffle-as-feature.md` to understand which retrieval modes need exact ranking vs which can use approximate.
