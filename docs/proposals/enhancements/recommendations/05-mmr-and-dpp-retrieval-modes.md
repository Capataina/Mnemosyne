...
6. Document the four diversity-aware modes in `docs/architecture/systems/cosine-similarity.md` (rename to `retrieval-modes.md` if the rename feels right). ~½ day.
