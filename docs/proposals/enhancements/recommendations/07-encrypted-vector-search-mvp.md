...
5. **Documentation + threat model (1 week).** A new `docs/architecture/systems/encrypted-vector-search.md` documenting the threat model, what FHE protects, what it leaks, what's not supported. The honest writeup is the portfolio artefact. ~5 days.
