...
6. Update `docs/engineering/decisions/conventions.md` to reflect the new IPC error pattern (currently documents the stringified version as the convention). ~½ day.

Required reading before starting: `docs/engineering/decisions/conventions.md` (current pattern), `docs/engineering/decisions/mutex-poisoning.md` (known foot-gun), `Suggestions.md` R4 (the user's stated intent).
