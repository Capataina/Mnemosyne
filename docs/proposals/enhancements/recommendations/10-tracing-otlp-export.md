...
Required reading before starting: `docs/architecture/systems/profiling.md` and `docs/engineering/decisions/performance-decisions.md` for the project's existing tracing model.
