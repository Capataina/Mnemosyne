...
9. Update `docs/architecture/systems/tag-system.md` and add `docs/architecture/systems/auto-tagging-and-dedup.md`. ~½ day.

Required reading before starting: `Roadmap.md` lines 71-72 (the user's existing intent), `docs/architecture/systems/tag-system.md` for the existing schema + UI patterns, `docs/engineering/decisions/random-shuffle-as-feature.md` for how the project thinks about UX-shaped retrieval choices.
