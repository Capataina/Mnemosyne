...
- `useOptimistic` is the React 19 formalism for optimistic updates; the project's pattern (per `docs/engineering/decisions/conventions.md`) already does this manually via TanStack Query.
