...
A1: The project's `docs/engineering/decisions/mutex-poisoning.md` explicitly names parking_lot as a strict upgrade for the three project Mutex singletons (DB connection, CosineIndex, TextEncoder). The vault Suggestions.md R4 also flags this.
