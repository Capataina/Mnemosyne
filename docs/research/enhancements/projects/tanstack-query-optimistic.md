...
A3: The project's `docs/engineering/decisions/conventions.md` documents this pattern verbatim and the implementation in `useImages.ts` / `useTags.ts` is canonical. This is a credibility marker — the project follows the framework's idiom precisely.
