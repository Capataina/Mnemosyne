...
# (query, max results to keep) — tuned for a ~250-piece library with varied
# subject matter, hue, and aspect ratio.
AIC_QUERIES = [
    ("figure drawing", 30),
    ("portrait painting", 25),
    ("japanese woodblock print", 30),
    ("landscape painting", 25),
    ("botanical", 20),
    ("still life painting", 20),
]
MET_QUERIES = [
    ("figure study drawing", 30),
    ("ukiyo-e", 25),
    ("watercolor landscape", 25),
    ("flower painting", 20),
]
